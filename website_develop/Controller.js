...
async function processData(data) {
  ...
  try {
    const response = await axios.post(
      "https://35e6-73-98-181-213.ngrok-free.app/process-url",
      {
        data,
      }
    );
...
async function generateReport(data) {
  try {
    ...
    const response = await axios.post(
      "https://35e6-73-98-181-213.ngrok-free.app/generate-report",
      {
        data,
      }
    );
...
async function generateSections(data) {
  try {
    ...
    const response = await axios.post(
      "https://35e6-73-98-181-213.ngrok-free.app/generate-sections",
      {
        data,
      }
    );
...
async function generateTitleReportByPDF(text) {
  try {
    ...
    const response = await axios.post(
      "https://35e6-73-98-181-213.ngrok-free.app/get-PDF-info",
      {
        text,
      }
    );
...
async function generateReportByPDF(text, userSettings, io, userID) {
  try {
    ...
    if (oldDocument) {
      ...
      const response = await axios.post(
        "https://35e6-73-98-181-213.ngrok-free.app/generate-reportByPDF",
        {
          text: text,
